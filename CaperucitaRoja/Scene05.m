...
-(void)didMoveToView:(SKView *)view {
    ...
    kid.physicsBody = [SKPhysicsBody bodyWithCircleOfRadius:kid.size.width/5];
    ...
    wolf.physicsBody = [SKPhysicsBody bodyWithCircleOfRadius:wolf.size.height];
    wolf.physicsBody.dynamic = NO;
...
-(void)nextScene{
    if (delegado.modoJuego == 0) {
        Scene06 *scene = [[Scene06 alloc] initWithSize:self.size];
